...
> A partir del 2019, cada 10 personas que se matriculan en propuestas, 5 son recurrentes, es decir, ya se han matriculado en al menos una propuesta formativa anteriormente.
...
-   En el año 2020 el grupo de *propuestas del campo de las tecnologías* tuvo un elevado número de personas (mayormente nuevas). Las propuestas con mayor número de personas fueron la *Actualización Académica Enseñar con Herramientas Digitales*, el *Taller la Clase en Pantuflas*, el *Seminario de Pensamiento Computacional* y el taller: *Dar clase con herramientas digitales.*
